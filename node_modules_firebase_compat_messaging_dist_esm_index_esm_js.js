"use strict";
(self["webpackChunkdlxl"] = self["webpackChunkdlxl"] || []).push([["node_modules_firebase_compat_messaging_dist_esm_index_esm_js"],{
...
/* harmony import */ var _firebase_app_compat__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @firebase/app-compat */ 63345);
/* harmony import */ var _firebase_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @firebase/component */ 51362);
/* harmony import */ var _firebase_messaging__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @firebase/messaging */ 44555);
/* harmony import */ var _firebase_util__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @firebase/util */ 21076);
/* harmony import */ var _firebase_messaging_sw__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @firebase/messaging/sw */ 18885);
...
/* harmony export */ });
/* harmony import */ var B_4la_f_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 10467);
/* harmony import */ var _firebase_installations__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @firebase/installations */ 19052);
/* harmony import */ var _firebase_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @firebase/component */ 51362);
/* harmony import */ var idb__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! idb */ 9699);
/* harmony import */ var _firebase_util__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @firebase/util */ 21076);
/* harmony import */ var _firebase_app__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @firebase/app */ 98742);
...
function _migrateOldDatabase() {
  _migrateOldDatabase = (0,B_4la_f_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (senderId) {
    ...
    const db = yield (0,idb__WEBPACK_IMPORTED_MODULE_3__.openDB)(OLD_DB_NAME, OLD_DB_VERSION, {
      upgrade: function () {
        var _ref = (0,B_4la_f_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (db, oldVersion, newVersion, upgradeTransaction) {
          var _a;
          if (oldVersion < 2) {
        ...
        return function upgrade(_x27, _x28, _x29, _x30) {
...
function _dbGet() {
  _dbGet = (0,B_4la_f_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies) {
...
function _dbSet() {
  _dbSet = (0,B_4la_f_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies, tokenDetails) {
    const key = getKey(firebaseDependencies);
    const db = yield getDbPromise();
...
function _dbRemove() {
  _dbRemove = (0,B_4la_f_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies) {
    const key = getKey(firebaseDependencies);
    const db = yield getDbPromise();
    const tx = db.transaction(OBJECT_STORE_NAME, 'readwrite');
...
function _requestGetToken() {
  _requestGetToken = (0,B_4la_f_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies, subscriptionOptions) {
...
function _requestUpdateToken() {
  _requestUpdateToken = (0,B_4la_f_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies, tokenDetails) {
    const headers = yield getHeaders(firebaseDependencies);
...
function requestDeleteToken(_x0, _x1) {
  return _requestDeleteToken.apply(this, arguments);
}
function _requestDeleteToken() {
  _requestDeleteToken = (0,B_4la_f_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies, token) {
    const headers = yield getHeaders(firebaseDependencies);
...
function getHeaders(_x10) {
  return _getHeaders.apply(this, arguments);
}
function _getHeaders() {
  _getHeaders = (0,B_4la_f_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* ({
    appConfig,
    installations
  }) {
...
function getTokenInternal(_x11) {
...
function _getTokenInternal() {
  _getTokenInternal = (0,B_4la_f_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (messaging) {
...
function deleteTokenInternal(_x12) {
  return _deleteTokenInternal.apply(this, arguments);
}
function _deleteTokenInternal() {
  _deleteTokenInternal = (0,B_4la_f_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (messaging) {
    const tokenDetails = yield dbGet(messaging.firebaseDependencies);
    if (tokenDetails) {
      yield requestDeleteToken(messaging.firebaseDependencies, tokenDetails.token);
...
function updateToken(_x13, _x14) {
  return _updateToken.apply(this, arguments);
}
function _updateToken() {
  _updateToken = (0,B_4la_f_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (messaging, tokenDetails) {
    try {
...
function getNewToken(_x15, _x16) {
...
function _getNewToken() {
  _getNewToken = (0,B_4la_f_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies, subscriptionOptions) {
...
function getPushSubscription(_x17, _x18) {
...
function _getPushSubscription() {
  _getPushSubscription = (0,B_4la_f_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (swRegistration, vapidKey) {
...
function stageLog(_x19, _x20) {
  return _stageLog.apply(this, arguments);
}
function _stageLog() {
  _stageLog = (0,B_4la_f_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (messaging, internalPayload) {
 ...
 * limitations under the License.
 */
function onSubChange(_x21, _x22) {
  return _onSubChange.apply(this, arguments);
}
function _onSubChange() {
  _onSubChange = (0,B_4la_f_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (event, messaging) {
    var _a, _b;
    const {
      newSubscription
    } = event;
...
function onPush(_x23, _x24) {
  return _onPush.apply(this, arguments);
}
function _onPush() {
  _onPush = (0,B_4la_f_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (event, messaging) {
...
function onNotificationClick(_x25) {
  return _onNotificationClick.apply(this, arguments);
}
function _onNotificationClick() {
  _onNotificationClick = (0,B_4la_f_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (event) {
    var _a, _b;
...
function _getWindowClient() {
  _getWindowClient = (0,B_4la_f_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url) {
    const clientList = yield getClientList();
...
function _isSwSupported() {
  _isSwSupported = (0,B_4la_f_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _firebase_messaging_compat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @firebase/messaging-compat */ 38202);
